function [evl,evr] = evec(maxnx,num_eqn,num_ghost,mx,q)
%
...
%   ---------------
    ...
    for i=2:mx2
        ...
        alpha = 0.5*gamma1 / c^2;

        evl(1,1,i) = (c*u/gamma1 + 0.5*u^2) * alpha;
        evl(2,1,i) = 2*(enth-u^2) * alpha;
        evl(3,1,i) = (-c*u/gamma1 + 0.5*u^2) * alpha;
