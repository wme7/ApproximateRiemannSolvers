...
%         Weighted Essentially Non-Oscilaroty (MOL-WENO5-SHLL)
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Notes: 
% 1. A fully conservative finite diference implementation of the method of
...
q=q0; it=0; dt=dt0; t=0; lambda=lambda0; figure(2);
...
title(s1,'MOL WENO-SHLL Euler Solver');