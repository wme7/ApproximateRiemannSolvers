function res = FV_WENO_EE2d_PrimitiveRecon(q,a,nx,ny,dx,dy,t,fluxMethod,Recon,Test)
...
parfor e=1:E
    switch Recon
        case 'WENO5', [wL(e,:),wR(e,:)] = WENO5recon_X(w(:,:,e),nx);
        case 'WENO7', [wL(e,:),wR(e,:)] = WENO7recon_X(w(:,:,e),nx);
        case 'Poly5', [wL(e,:),wR(e,:)] = POLY5recon_X(w(:,:,e),nx);
        case 'Poly7', [wL(e,:),wR(e,:)] = POLY7recon_X(w(:,:,e),nx);
        otherwise, error('reconstruction not available ;P');
    end
end
...
for e=1:E
    switch Recon
        ...
        case 'Poly5', [wL(e,:),wR(e,:)] = POLY5recon_Y(w(:,:,e),ny);
        case 'Poly7', [wL(e,:),wR(e,:)] = POLY7recon_Y(w(:,:,e),ny);
    end
end
