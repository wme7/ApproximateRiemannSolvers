...
while t < tEnd
    ...
    % 1st stage
    L=FD_EE2d(q,a,nx,ny,dx,dy,t,fspltMth,reconMth,'DMR'); q=qo-dt*L;
    
    % 2nd Stage
    L=FD_EE2d(q,a,nx,ny,dx,dy,t,fspltMth,reconMth,'DMR'); q=0.75*qo+0.25*(q-dt*L);
    
    % 3rd stage
    L=FD_EE2d(q,a,nx,ny,dx,dy,t,fspltMth,reconMth,'DMR'); q=(qo+2*(q-dt*L))/3;
